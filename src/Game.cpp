...
void Game::update(float elapsedTime){
	...
	//Check enemies
	std::vector<Enemy*> othersEnemies;
	if ((othersEnemies = this->_level.checkEnemyCollisions(this->_player.getBoundingBox())).size() > 0){
		this->_player.handleEnemyCollisions(othersEnemies);
	}
}